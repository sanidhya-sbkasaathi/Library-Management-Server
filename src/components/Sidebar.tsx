...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, onSelectTab }) => {
  ...
  return (
    <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200/80 dark:border-slate-800 flex flex-col justify-between shrink-0 select-none z-20 transition-colors duration-200">
      ...
      {/* Bottom Promo Card matching Image 3: "Powering Your Libraries" */}
      <div className="p-4">
